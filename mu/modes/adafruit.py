...
class AdafruitMode(MicroPythonMode):
    ...
    description = "Use CircuitPython on Adafruit's line of development boards."
    icon = 'adafruit'
    ...
    def workspace_dir(self):
        ...
        if device_dir:
            ...
            if self.connected:
                m = 'Could not find an attached Adafruit CircuitPython device.'
                info = ("Python files for Adafruit CircuitPython devices"
