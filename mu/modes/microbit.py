...
class MicrobitMode(MicroPythonMode):
    ...
    def actions(self):
        ...
        return [
            {
                'name': 'flash',
                'description': 'Flash your code onto the micro:bit.',
                'handler': self.flash,
            },
            {
                'name': 'files',
                'description': 'Access the file system on the micro:bit.',
                'handler': self.toggle_files,
            },
            {
                'name': 'repl',
                'description': 'Use the REPL to live-code on the micro:bit.',
